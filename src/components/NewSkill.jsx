    ...
    <div className="box">
      ...
      <form onSubmit={handleSubmit}>
        <div className="field">
          ...
          <p className="help">
            Commonly used name of the represented technical skill, language, or
            technique
          </p>
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <p className="help">
            Importance to EC area based on staffing needs, scale of 0-5 with "0"
            values representing a core need
          </p>
        </div>
